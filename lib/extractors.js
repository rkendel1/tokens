    ...
    try {
      ...
      hoursBlocks.forEach(block => {
        ...
        if (matches) {
          ...
          if (block.toLowerCase().includes('hour') || 
              block.toLowerCase().includes('open') || 
              block.toLowerCase().includes('close') ||
              block.toLowerCase().includes('mon') ||
              block.toLowerCase().includes('tue') ||
              block.toLowerCase().includes('wed') ||
              block.toLowerCase().includes('thu') ||
              block.toLowerCase().includes('fri') ||
              block.toLowerCase().includes('sat') ||
              block.toLowerCase().includes('sun') ||
